...
parser.add_argument("--model_path", type=str, default="D:\\1models\\deepseek_7b_finetune")
...
def check_model_v(img_file_path: str = None):
    ...
    Returns:
        Ture if model is Deepseek else False
    '''
    if "Deepseek" in model_architectures:
        return True
    if isinstance(img_file_path, str):
        gr.Warning('Only Deepseek model can support Image')
    return False
...
with gr.Blocks(theme="soft") as demo:
    gr.Markdown("""# deepseek-7b-finetune Gradio Demo""")
